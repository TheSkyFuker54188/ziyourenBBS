...
if($_GET['act'] == 'add'){
    ...
    echo '<th>' . $Lang['order_plugin_id'] . '</th>';
    ...
    foreach ($orderList as $key => $value) {
        ...
        $pluginInfo = C::t('#tom_pay#common_plugin')->fetch_by_identifier($value['plugin_id']);
        
        echo '<tr>';
        if($pluginInfo){
            echo '<td>' . $pluginInfo['name'] . '</td>';
        }else{
            echo '<td>' . $value['plugin_id'] . '</td>';
        }
        ...
        if($value['payment'] == 'wxpay_jsapi'){
            ...
            if($value['order_status'] == 1 && (TIMESTAMP - $value['order_time']) < 3500){
            ...
            echo '</td>';
        }else if($value['payment'] == 'douyin_pay'){
            echo '<td><font color="#0894fb">' . $Lang['douyin_pay'] . '</font></td>';
        }else if($value['payment'] == 'kuaishou_pay'){
            echo '<td><font color="#0894fb">' . $Lang['kuaishou_pay'] . '</font></td>';
        }else{
            echo '<td>-</td>';
        }
