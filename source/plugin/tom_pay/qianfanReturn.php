...
$qf_hosts       = trim($payConfig['qf_hosts']);
$qf_token       = trim($payConfig['qf_token']);

define("QF_HOSTS", $qf_hosts);
define("QF_TOKEN", $qf_token);
...
$qf_content = $client->get('payments/'.$qf_order_id);
if($qf_content){
    if ($qf_content['data']['pay']==1) {
