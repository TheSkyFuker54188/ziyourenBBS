...
if (!function_exists('ispluginkey')) {
	...
	if (!empty($identifier) && ispluginkey($identifier)) {
		...
		if (!getcookie('splugin_think_' . $identifier) || (abs($_G['timestamp'] - getcookie('splugin_think_' . $identifier)) > 86400)) {
			...
			if (splugin_cloudaddon('&mod=app&ac=validator&addonid=' . $addonid . ($array !== false ? '&rid=' . $array['RevisionID'] . '&sn=' . $array['SN'] . '&rd=' . $array['RevisionDateline'] : '')) === '0') {
				...
				echo "&#x611F;&#x8C22;&#x4F7F;&#x7528;1314&#x5B66;&#x4E60;&#x7F51;&#x7684;&#x63D2;&#x4EF6;&#xFF0C;&#x767E;&#x5EA6;&#x641C;&#x7D22; 1314&#x5E94;&#x7528;&#x4E2D;&#x5FC3; &#x83B7;&#x53D6;&#x66F4;&#x591A;&#x5E94;&#x7528;&#x3002;<div style='display:none'>\n2026020503EsqYX4w9RY\n88501\n1678365327\nhttp://43.143.218.163/\nhttp://43.143.218.163/\nAA343C44-8803-A0BF-D820-DA2BEED3487D\n00C0EF5F-1DC4-17B1-D9D5-B8865E66ACDB</div>";
			}
		}
	}
}
...
function s_shownav($header = '', $menu = '', $nav = '') {
	...
	$title = '<' . 'span' . '>&#x672C;&#x63D2;&#x4EF6;&#x7531;1314&#x5B66;&#x4E60;&#x7F51;&#x5F00;&#x53D1;&#xFF0C;&#x4F7F;&#x7528;&#x95EE;&#x9898;&#x8BF7;&#x5230;1314&#x5B66;&#x4E60;&#x7F51;&#xFF08;<' . 'a hr' . 'ef' . '="htt' . 'p:/' . '/ww' . 'w.1' . '314s' . 'tud' . 'y.co' . 'm/" tar' . 'get="_blank" class="a1314">ww' . 'w.13' . '14' . 'st' . 'udy.co' . 'm</' . 'a>&#xFF09;&#x53CD;&#x9988;</span' . '><style>.currentloca .a1314{display: unset;position: unset;background-color: unset; color: #000000;}.currentloca .a1314::before, .currentloca .a1314::after {background: #2b7acd;width: 0px;height: 0px;}}</style>';
